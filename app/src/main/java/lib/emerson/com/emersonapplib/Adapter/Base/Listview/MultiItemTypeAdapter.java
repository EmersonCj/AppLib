...
import lib.emerson.com.emersonapplib.Adapter.Base.Listview.Item.ItemViewDelegateManager;


/**
 * Created by YangJianCong on 2016/10/19.
 * <p>
 * 支持多种Item类型的布局的Adapter
 * <p>
 * 对于多种布局的Item，需要去复写BaseAdapter的getViewTypeCount()和getItemViewType()。
 * 并且需要在getView()里面进行判断以及选取布局文件，不同的布局也需要采用不同的ViewHolder。
 */
