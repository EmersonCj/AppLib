...
/**
 * Created by YangJianCong on 2016/10/10.
 */
public class MDViewActivity extends baseActivity {
    ...
    @ViewInject(R.id.main_iv_placeholder)
    private ImageView mIvPlaceholder; // 大图片

    @ViewInject(R.id.main_ll_title_container)
    private LinearLayout mLlTitleContainer; // Title的LinearLayout

    @ViewInject(R.id.main_fl_title)
    ...
    @ViewInject(R.id.main_tv_toolbar_title)
    private TextView mTvToolbarTitle; // 标题栏Title

    @ViewInject(R.id.main_tb_toolbar)
