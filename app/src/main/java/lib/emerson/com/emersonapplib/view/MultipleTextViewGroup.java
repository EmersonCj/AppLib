...
public class MultipleTextViewGroup extends RelativeLayout {
    ...
    public MultipleTextViewGroup(Context context, AttributeSet attrs) {
        ...
        textColor = array.getColor(R.styleable.MultipleTextViewGroup_textColor3, 0XFF00FF00); // 提供默认值，放置未指定
        textSize = array.getDimension(R.styleable.MultipleTextViewGroup_textSize3, 24);
